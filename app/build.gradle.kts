...
android {
    ...
    defaultConfig {
        applicationId = "com.example.muzpleer_4tabs"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    compileOptions {
        sourceCompatibility = JavaVersion.VERSION_17 // Измените с VERSION_11
        targetCompatibility = JavaVersion.VERSION_17 // Измените с VERSION_11
    }
    kotlinOptions {
        jvmTarget = "17" // Измените с "11"
    }
    buildFeatures {
        viewBinding = true
    }
